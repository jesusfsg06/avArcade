...
<div class="member_login">
	       ...
	       <a href="<?php echo $user['url'];?>"><img class="avatarIMG" src="<?php echo $user['avatar'];?>" alt="Avatar" /></a>
	           ...
	           <p class="member_title">Welcome, <?php echo $user['username'];?></p><span style="float:left; margin: 0 0 0 10px; color: #8f2800; background-color: #fff000; padding: 2px 5px; font: 11px arial;"><?php echo $user['points'];?></span>
	           <?php if ($user['admin'] == 1) { ?>
	         ...
	         <div style="float:left; width: 400px; margin: 0 0 0 5px;">
	           ...
	           <p class="member_log_buttons"><a href="<?php echo $user['url'];?>">Profile</a></p>
