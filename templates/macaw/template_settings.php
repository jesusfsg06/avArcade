...
// Highscore image
$template['highscore_image'] = '<img style="border:0;" src="'.$setting['site_url'].'/images/trophy_smaller.png" />';
...
$template['homepage_game_limit'] = 16; // Number of games to show per caregory on the homepage
$template['random_game_limit'] = 16; // Number of games to show in the random games section
$template['games_per_page'] = 30; // Number of games to show per page in categories
$template['comments_per_page'] = 2; // Number of comments to show per page on game pages (5.5)

$template['category_game_chars'] = 24; // The character limit for game names in categories
$template['category_game_desc_chars'] = 55; // The character limit for game descriptions in categories
$template['homepage_game_chars'] = 23; // The character limit for game names in categories
...
$template['featured_game_desc_chars'] = 100; // The character limit for featured game descriptions (5.5)
$template['random_game_chars'] = 14; // The character limit for the random game names
$template['random_game_desc_chars'] = 200; // The character limit for the random game descriptions
$template['module_max_chars'] = 25; // The character limit modules (game names, news)
$template['player_module_max_chars'] = 20; // The character limit modules (game names, news)
