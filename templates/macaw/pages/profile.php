...
<div class="sidebar">
	    ...
	    <div class="sidebar_BOX">
	       ...
	       <p class="sb_profilename"><?php echo $profile['name'];?> <span class="sb_points"><?php echo $profile['points'];?> Points</span></p>	       
           ...
           <p class="sb_profile_title">Profile Information:</p>
...
<h1 class="browse_cat_title"><?php include (  './includes/modules/content_title.php'  ); // Include the page title ?>'s Profile</h1>
