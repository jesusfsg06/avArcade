...
<div class="advertisement_leader">
    ...
    <ins class="adsbygoogle"
         ...
         data-ad-client="ca-pub-2441810032412224"
         data-ad-slot="1521073395"></ins>
    <script>
        (adsbygoogle = window.adsbygoogle || []).push({});
    </script>
</div>

<span class="browse_cat">Browse games by category</span>
...
$sql = mysql_query("SELECT * FROM ava_cats ORDER BY cat_order ASC LIMIT 8");
$total_cats2 = 0;
