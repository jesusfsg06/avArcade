...
$template['homepage_game_limit'] = 6; // Number of games to show per caregory on the homepage
$template['random_game_limit'] = 5; // Number of games to show in the random games section
$template['games_per_page'] = 22; // Number of games to show per page in categories
$template['comments_per_page'] = 8; // Number of comments to show per page on game pages (5.5)

$template['category_game_chars'] = 20; // The character limit for game names in categories
...
$template['featured_game_chars'] = 20; // The character limit for featured game names (5.5)
$template['featured_game_desc_chars'] = 65; // The character limit for featured game descriptions (5.5)
...
$template['module_max_chars'] = 20; // The character limit modules (game names, news)
