<div class="post_container" id="<?php echo $post['id'];?>">
	...
	<div class="post_user_info">
		<a style="font: 14px arial; font-weight:bold; color: #000000; padding: 5px; display: block; background-color: #ffffff; -webkit-border-radius:5px;-khtml-border-radius:5px;border-radius:5px;" href="<?php echo $post_user['profile_url'];?>"><?php echo $post_user['username'];?></a>
