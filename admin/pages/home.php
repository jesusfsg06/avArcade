...
<div class="version">AV Arcade <?php echo $version;?>

<?php 
if (isset($ava_needs_updating)) {
	echo '<br /><span style="font-size:12px;">The reccommended minimum version for AV Forums '.$forums_version_number.' is AV Arcade '.$forums_required_version.'</span>';
}
else if (isset($forums_need_updating)) {
